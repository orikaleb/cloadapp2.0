...
function LoginPageContent() {
  ...
  const { processPendingItems } = useCart();
  ...
  }, [isAuthenticated, processPendingItems, router, searchParams]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        // Process pending items in background, don't wait
        processPendingItems();
        // Redirect immediately
        const redirect = searchParams.get('redirect') || '/products';
        router.push(redirect);
      } else {
        setError(result.error || 'Invalid email or password. If you do not have an account, please sign up.');
        setIsLoading(false);
      }
    } catch (err) {
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden animate-fade-in border border-gray-200">
            ...
            <div className="bg-blue-600 p-8 text-center">
              ...
              <p className="text-blue-100 text-sm">Sign in to continue to CloudStore</p>
            </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onBlur={() => setFocusedField(null)}
                      className="w-full pl-12 pr-12 py-3 border-2 border-gray-200 rounded-xl focus:border-blue-500 focus:ring-4 focus:ring-blue-100 transition-all duration-200 bg-white text-gray-900 placeholder-gray-400"
                  ...
                  <div className="bg-red-50 border-l-4 border-red-500 p-4 rounded-lg animate-slide-in">
                    <div className="flex items-start">
                      ...
                      <div className="flex-1">
                        ...
                        {error.includes('do not have an account') && (
                          <a 
                            href="/auth/register" 
                            className="mt-2 inline-block text-sm text-blue-600 hover:text-blue-700 font-semibold underline"
                          >
